...
class TextCollector:
    def __init__(self, soup, folder_path):
        ...
        self.threadNumber = self.threadIntro.find("a").get("id").replace("post_no_", "")
        ...
        self.postReplies = soup.find_all(class_="reply")
    ...
    def extract_datetime(self, post):
        ...
        post_date = post.find(class_='intro')
    ...
    def extract_original_post(self):
        ...
        original_content = {
            ...
            "username": self.originalPost.find(class_="name").get_text().strip().replace("\n", ""),
    ...
    def extract_replies(self):
        ...
        for reply in self.postReplies:
            ...
            reply_content = {
                "post_id": reply.get("id").replace("reply_", ""),
            ...
            replies[reply["id"].replace("reply_", "")] = reply_content
