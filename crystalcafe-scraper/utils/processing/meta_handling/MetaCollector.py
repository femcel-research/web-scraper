...
class MetaCollector:
    ...
    THREAD_META_PATH = Template("./data/crystal.cafe/$t/thread_meta_$t.json")  # $t for thread id

    def __init__(self, url, soup, folder_path):
        # Website info
        self.soup = soup
        self.url = url
        self.file_path: str
    ...
    def get_dates(self):
        datefinder = DateFinder(self.soup)
